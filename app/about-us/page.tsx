        ...
        <>
            ...
            <div className={styles.container}>
                <h1 className={styles.heading}>
                    ...
                    collaboration<br /> between   one another.
                </h1>
...
ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia.</p>
</div>
...
<div className="team-section">
      ...
      <div className="team-member">
        <img src="/images/person5.jpg" alt="Member 5" />
        <div className="info">
          <h3>Your Name</h3>
          <p>Designation</p>
        </div>
