...
const ContactForm = () => {
  return (
    <div className="border-black border-b-[1px] mb-4">
      <div className="md:px-32 pb-24 md:pb-0 px-8  max-w-[1366px] mr-auto ml-auto  ">
        <div>
          <h2 className="text-[16px] font-normal">Contact Us</h2>
          <h1 className="text-[40px] font-[600] -ml-1 mt-2">
