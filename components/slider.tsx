...
import './slider.css'; 
const slides = [
  { id: 1, image: slider, title: 'California, USA', subtitle: '4 beds / 3 Bath', price: 'Rp 2.500.000' },
  { id: 2, image: Arizona, title: 'Syltherine', subtitle: 'Stylish cafe chair', price: 'Rp 2.500.000' },
  { id: 3, image: Kenya, title: 'Syltherine', subtitle: 'Stylish cafe chair', price: 'Rp 2.500.000' },
  { id: 4, image: Cambodia, title: 'Syltherine', subtitle: 'Stylish cafe chair', price: 'Rp 2.500.000' },
];

const Slider = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [transitionData, setTransitionData] = useState<typeof slides[0] | null>(null);
        ...
        <div className="slider-info"> 
          <AnimatePresence mode="wait">
            ...
            >
              ...
              ></motion.div>
              <motion.p layoutId={slides[currentSlide].subtitle} className="slider-subtitle">
          ...
          <div className="slider-thumbnails">
            ...
            {slides.map((slide, index) => (
              ...
              >
                <img src={slide.image.src} alt={slide.title} className="thumbnail-image" />
