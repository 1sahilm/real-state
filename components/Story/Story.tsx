    ...
    >
      ...
      <div className={Styles.offer}>
        <div className={Styles.box}>
          <Image src={require("../../assets/Banner/pexels-alex-staudinger-829197-1732414.jpg")} style={{width:"100px", height:"100px", objectFit:'contain'}} alt="home"/>
        ...
        <div className={Styles.box}>
          <Image src={require("../../assets/Banner/pexels-pixabay-262048.jpg")} style={{width:"100px", height:"100px", objectFit:'contain'}}  alt="home"/>
        ...
        <div className={Styles.box}>
          <Image src={require("../../assets/Banner/unsplash_2gDwlIim3Uw.png")} style={{width:"100px", height:"100px", objectFit:'contain'}}  alt="home"/>
